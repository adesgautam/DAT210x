...
model.fit(df[['TowerLat','TowerLon']])

clusters.append(model.cluster_centers_)

ax.scatter(model.cluster_centers_[:, 0], model.cluster_centers_[:, 1], c='r', marker='x', s=168, alpha=0.7, linewidths=2)
