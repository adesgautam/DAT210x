...
#
# .. your code here ..
X = pd.read_csv("Datasets/College.csv",header=0)
#X.rename(columns={'': 'A'})
print(X.head())
...
accept_stud = X[['Accept']]

X_train, X_test, y_train, y_test = train_test_split(room_board, accept_stud, test_size=0.3, random_state=7)
#
...
X_train, X_test, y_train, y_test = train_test_split(enroll, accept_stud, test_size=0.3, random_state=7)
#
# TODO: Fit and score your model appropriately. Store the score in the
# score variable.
#
...
# .. your code here ..
accept_stud = X[['Accept']]
F_undergrads = X[['F.Undergrad']]

X_train, X_test, y_train, y_test = train_test_split(accept_stud, F_undergrads, test_size=0.3, random_state=7)
#
# TODO: Fit and score your model appropriately. Store the score in the
# score variable.
#
...
#
# .. your code here ..
room_enroll = X[['Room.Board','Enroll']]
accept_stud = X[['Accept']]

X_train, X_test, y_train, y_test = train_test_split(room_enroll, accept_stud, test_size=0.3, random_state=7)
#
# TODO: Fit and score your model appropriately. Store the score in the
# score variable.
#
