...
def doKMeans(data, clusters=0):
  ...
  #
  # .. your code here ..
  dataframe = pd.concat([data.TowerLat, data.TowerLon], axis = 1)
...
# .. your code here ..
for i in range(0,10):
  user = df[df['In']==unique_numbers[i]].reset_index()
  print("user "+ str(user['In'].unique()) + str(i) + " Lat; ")
  print(user['TowerLat'].mean())
  print("Lon; ")
  print(user['TowerLon'].mean())
  print("\n")

user1 = df[df['In']==unique_numbers[0]].reset_index()
#
