...
#
# .. your code here ..
li = ['sample', 'thickness', 'size', 'shape', 'adhesion', 'epithelial', 'nuclei', 'chromatin', 'nucleoli', 'mitoses', 'status']
...
#T = preprocessing.StandardScaler().fit_transform(df)  # 0.957142857143
#T = preprocessing.MinMaxScaler().fit_transform(df)    # 0.965714285714
#T = preprocessing.MaxAbsScaler().fit_transform(df)    # 0.965714285714
#T = preprocessing.Normalizer().fit_transform(df)      # 0.848571428571
#T = preprocessing.RobustScaler().fit_transform(df)    # 0.957142857143
T = df # No Change                                     # 0.965714285714
#print(T.describe())
...
#
# .. your code here ..
X_train, X_test, label_train, label_test = train_test_split(X, labels, test_size=0.5, random_state=7)
...
#
# .. your code here ..
  accuracy_score = knn.score(X_test, label_test)
  print("\n")
